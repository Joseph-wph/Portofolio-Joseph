  ...
  return (
    <div className="mx-auto w-full flex flex-col justify-center items-center gap-5 font-heading p-5">
      ...
      <div className="flex flex-col lg:flex-row gap-5">
        <div className="bg-secondary w-120 h-150 rounded-4xl flex flex-col justify-center items-center p-5 gap-5">
          ...
          <p className="flex items-center gap-2 font-semibold text-[20px]">
            <IoMdCheckmark />
            React Expert
          </p>
          <p className="flex items-center gap-2 font-semibold text-[20px]">
        ...
        <div className="border border-slate-400 w-120 h-150 rounded-4xl flex flex-col justify-center items-center p-5 gap-5">
